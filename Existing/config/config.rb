...
#AppConfig[:pui_hide] = {}
#AppConfig[:pui_hide][:repositories] = false #called "Repositories" on the PUI
#AppConfig[:pui_hide][:resources] = false #called "Collections" on the PUI
#AppConfig[:pui_hide][:digital_objects] = false #called "Digital Materials" on the PUI
AppConfig[:pui_hide][:accessions] = true #called "Unprocessed Material" on the PUI
AppConfig[:pui_hide][:subjects] = true #called "Subjects" on the PUI
AppConfig[:pui_hide][:agents] = true #called "Names" on the PUI
AppConfig[:pui_hide][:classifications] = true #called "Record Groups" on the PUI 
#AppConfig[:pui_hide][:search_tab] = false #shown at the lens on the PUI
